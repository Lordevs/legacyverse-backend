...
class Profile(models.Model):
    ...
    joined_date = models.DateField(
        null=True, blank=True, help_text="User-provided joined date"
    )
    ...
    sections = models.JSONField(
        default=list, blank=True, help_text="Array of profile sections"
    )
...
class SectionImage(models.Model):
    ...
    profile = models.ForeignKey(
        Profile, on_delete=models.CASCADE, related_name="section_images"
    )
    section_id = models.CharField(
        max_length=100, help_text="ID of the section this image belongs to"
    )
...
class FamilyRelationship(models.Model):
    ...
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="initiated_relationships"
    )
    relative = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="received_relationships"
    )
