...
SECRET_KEY = config(
    "SECRET_KEY",
    default="django-insecure-!ousu95+8v-oop*5by2r!*zv5c5o+da&5#=mp@5e@lgst@(!lx",
)
...
ALLOWED_HOSTS = config(
    "ALLOWED_HOSTS",
    default="localhost,127.0.0.1,api.memoriva.org",
...
FILE_UPLOAD_MAX_MEMORY_SIZE = (
    100 * 1024 * 1024
)  # 100MB - files larger than this will be written to disk
